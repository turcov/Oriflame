 ...
 * @author Turkov S
 */
@WebServlet(name = "removenewscms", urlPatterns = {"/cms/removenewscms.html"})
public class removenewscms extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<News> newsListRU=newsService.findAllTitlesNewsByLocale("ru_RU");
        List<News> newsListMD=newsService.findAllTitlesNewsByLocale("ro_MD");
        List<News> newsListEN=newsService.findAllTitlesNewsByLocale("en_US");
