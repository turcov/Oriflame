 ...
 * @author Turkov S
 */
@WebServlet(name = "readmessagecms", urlPatterns = {"/cms/readmessagecms.html"})
public class readmessagecms extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Message message=messagesService.readMessagebyId(id);
        message.setIsReaded(true);
        messagesService.setReadedMessage(message);
        request.setAttribute("message", message);
        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/pages/cms/cmsreadmessage.jsp");
