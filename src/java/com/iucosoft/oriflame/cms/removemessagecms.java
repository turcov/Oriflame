 ...
 * @author Turkov S
 */
@WebServlet(name = "removemessagecms", urlPatterns = {"/cms/removemessagecms.html"})
public class removemessagecms extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        messagesService.removeMessageById(id);
