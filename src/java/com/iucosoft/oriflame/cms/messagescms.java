 ...
 * @author Serguei
 */
@WebServlet(name = "messagescms", urlPatterns = {"/cms/messagescms.html"})
public class messagescms extends HttpServlet {
    private static final Logger LOG = Logger.getLogger(messagescms.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Message> messagesList=messagesService.findAllTitlesMessages();
        request.setAttribute("messagesList", messagesList);
        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/pages/cms/cmsmessages.jsp");
