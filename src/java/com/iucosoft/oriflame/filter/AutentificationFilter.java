...
import com.iucosoft.oriflame.services.AutentificationException;
...
public class AutentificationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        HttpServletResponse aHttpServletResponse = (HttpServletResponse) response;
        try {
            HttpSession session = aHttpServletRequest.getSession();
            if (session == null) {
                throw new Exception("Session is null");
            }
            if (session.getAttribute("MAIN_USER") == null) {
                throw new AutentificationException("Session expired");
            }
            ...
            problem = t;
            t.printStackTrace();
            aHttpServletResponse.sendRedirect(aHttpServletRequest.getContextPath()+"/error2.jsp");
        }
